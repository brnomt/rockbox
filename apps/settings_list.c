...
/** End of old RTC config block **/
    ...
    INT_SETTING(F_NO_WRAP, timed_brightness_night_hour,
                -1, 23, "timed brightness night hour", UNIT_HOUR,
                0, 23, 1, NULL, NULL, timed_brightness_cb_int),
    INT_SETTING(F_NO_WRAP, timed_brightness_night_min,
                -1, 0, "timed brightness night min", UNIT_MIN,
                0, 59, 1, NULL, NULL, timed_brightness_cb_int),
...
#undef EQ_BAND
    ...
    /* global input trim (PGA, first stage of the chain) */
    INT_SETTING_NOWRAP(F_SOUNDSETTING, input_gain, LANG_INPUT_GAIN, 0,
                       "input gain", UNIT_DB, -300, 60, 5,
                       db_format, get_dec_talkid, dsp_set_input_gain),
...
INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.crossover_hz,
                   ...
                   "bassboost crossover", UNIT_HERTZ, 40, 500,
                   10, NULL, NULL, bassboost_set),
INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.sub_bass_gain,
                   LANG_BASSBOOST_SUB_BASS_GAIN, 120,
                   "bassboost sub gain", UNIT_DB, 0, 240,
                   5, db_format, get_dec_talkid, bassboost_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.harmonics,
                       LANG_BASSBOOST_HARMONICS, 0,
                       "bassboost harmonics", UNIT_PERCENT, 0, 100,
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crystalizer_settings.intensity_mid,
                       ...
                       "crystalizer intensity mid", UNIT_PERCENT, -240, 240,
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crystalizer_settings.intensity_high,
                       ...
                       "crystalizer intensity high", UNIT_PERCENT, -240, 240,
                       5, NULL, NULL, crystalizer_set),
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crystalizer_settings.output_gain,
                       ...
                       5, db_format, get_dec_talkid, crystalizer_set),
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, exciter_settings.cutoff_hz,
                       ...
                       "exciter cutoff", UNIT_HERTZ, 2000, 8000,
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, widener_settings.crossover_hz,
                       ...
                       "widener crossover", UNIT_HERTZ, 50, 500,
