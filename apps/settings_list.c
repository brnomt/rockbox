...
#undef EQ_BAND
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.threshold,
     ...
     CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, bassboost_settings.ratio_up,
                    ...
                    "bassboost ratio up",
                     "off,0.10:1,0.15:1,0.25:1,0.5:1,0.75:1", bassboost_set, 6,
                     ID2P(LANG_BASSBOOST_RU_OFF),
                     ID2P(LANG_BASSBOOST_RU_10),
                     ID2P(LANG_BASSBOOST_RU_15),
    ...
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       ...
                       10, NULL, NULL, bassboost_set),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       bassboost_settings.up_attack_ms,
                       LANG_BASSBOOST_UP_ATTACK, 1,
                       "bassboost up attack", UNIT_MS, 1, 500,
                       5, NULL, NULL, bassboost_set),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       bassboost_settings.up_release_ms,
                       LANG_BASSBOOST_UP_RELEASE, 20,
                       "bassboost up release", UNIT_MS, 1, 500,
                       5, NULL, NULL, bassboost_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.max_up_gain_db,
                       LANG_BASSBOOST_MAX_UP_GAIN, 140,
                       "bassboost max up gain", UNIT_DB, 0, 240,
                       5, NULL, NULL, bassboost_set),
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.spread,
                       ...
                       5, NULL, NULL, bassboost_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, bassboost_settings.sub_octave,
                       LANG_BASSBOOST_SUB, 0,
                       "bassboost sub octave", UNIT_PERCENT, 0, 100,
                       5, NULL, NULL, bassboost_set),
